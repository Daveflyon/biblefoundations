...
(function () {
  ...
  function createPlayButton() {
    ...
    btn.type = 'button';
    btn.className = 'btf-play-section-btn btf-on-light';
  ...
  function addPlayBar(container, collapsible) {
    ...
    bar.className = collapsible ? 'btf-play-bar' : 'btf-play-bar btf-play-always';
  ...
  function removePlaySectionUI(root) {
    ...
    scope.querySelectorAll('.btf-play-bar').forEach(function (el) { el.remove(); });
  ...
  function createAudioEngine(opts) {
    ...
    var progressEl = $('#btf-audio-progress');
    ...
    function updateUI() {
      ...
      sections.forEach(function (sec) {
        ...
        if (currentSec === sec) {
          ...
          if (sec.el) sec.el.classList.add('btf-section-playing');
        } else {
          sec.playBtn.innerHTML = I_PLAY + ' Play Section';
          sec.playBtn.classList.remove('btf-btn-active');
          if (sec.el) sec.el.classList.remove('btf-section-playing');
  ...
  function addMinimiseButton(body, onMinimise) {
    if (!body || body.querySelector('.btf-minimise-btn')) return;
    var btn = document.createElement('button');
    btn.type = 'button';
    btn.className = 'btf-minimise-btn';
  ...
  function initLessonNav() {
    ...
    $$('section[id]').forEach(function (section) {
      ...
      if (toggle && body) {
        ...
        if (!body.querySelector('.btf-play-bar')) {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var page = document.body.getAttribute('data-btf-page');
