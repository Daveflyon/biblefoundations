...
(function () {
  ...
  function lessonLabel() {
    ...
    return parts[0] ? parts[0].trim() : 'Bible Truth Foundations Lesson';
  }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    if (document.body.getAttribute('data-btf-page') !== 'lesson') return;
    ...
    if (downloadBtn) {
      downloadBtn.addEventListener('click', function () {
        ...
        var lines = [
          'Bible Truth Foundations: Part 1 of 3',
          lessonLabel(),
